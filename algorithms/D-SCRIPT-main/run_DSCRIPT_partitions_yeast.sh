...
do
  ...
  { time dscript evaluate --test data/partitions/${DATASET}_partition_1.txt --embedding /nfs/scratch/jbernett/yeast_embedding.h5 --model ./models/${DATASET}_0_1_dscript_partitions_final.sav  -o ./results_dscript/partitions/${DATASET}_both_1.txt -d 0; } 2> results_dscript/partitions/${DATASET}_both_1_time.txt
