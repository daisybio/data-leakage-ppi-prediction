...
do
  ...
  do
    ...
    do
      ...
      { time dscript evaluate --test data/partitions/${DATASET}_partition_${TEST}.txt --embedding /nfs/scratch/jbernett/yeast_embedding.h5 --model ./models/${DATASET}_${TRAIN}_${TEST}_dscript_partitions_final.sav  -o ./results_dscript/partitions/${DATASET}_${TRAIN}_${TEST} -d 2; } 2> results_dscript/partitions/${DATASET}_${TRAIN}_${TEST}_time.txt
