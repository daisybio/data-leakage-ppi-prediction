...
cd SPRINT
echo SPRINT
{ time bin/predict_interactions -p data/Uniprot_human_protein_sequences.fasta -h HSP/pre_computed_HSP -tr data/original/dscript_train_pos.txt -pos data/original/dscript_test_pos.txt -neg data/original/dscript_test_neg.txt -o results/original/dscript_results.txt ; } 2> results/original/dscript_time.txt
